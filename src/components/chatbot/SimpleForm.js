...
const theme = {
  ...
  headerBgColor: '#f44336', // Change this color to your desired value
  headerFontColor: '#fff',
  headerFontSize: '15px',
  botBubbleColor: '#0c8820',
  botFontColor: '#fff',
  userBubbleColor: '#eaf408',
...
const steps = [
  // Define your chatbot steps here
    {      
id: '13',
...
{
id: '5',
message: 'Dekan kito kini pak RG. Guntur Alam, S.Pd, M.Kom',
trigger: '7'
}
];
